...
<div>
<h2 class="title mt-5">Payment</h2>
    ...
    <div class="container">
        <div class="row d-flex justify-content-center align-items-center my-5">
            <div class="col-6">
            <a href="order.php?user_id=<?php echo $user_id?>"><h3 class="text-center text-decoration-none">Pay Online</h3></a>
            </div>
            <div class="col-6">
                <a href="order.php?user_id=<?php echo $user_id?>"><h3 class="text-center text-decoration-none">Pay Offline</h3></a>
            </div>
        </div>
    </div>
</div>
